...
public class WiFiTest extends Activity {
	...
	private enum SearchState {close,search,firstly,badly,well};//断开，搜索，信号糟，信号良好
	...
	private static final int FIRSTLY =2;
	private static final int BADLY =3;
	...
	class getWiFiRssi extends TimerTask {
        ...
        public void run() {
    		...
    		if(isSearchState == SearchState.search){
    			msg = new Message();
    			msg.what = FIRSTLY;
				mHandler.sendMessage(msg); 
